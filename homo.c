...
int main(){
	...
	case 1: {for(int i = 0; i < 3; i++){
		...
		mat2[0][0] = 1; mat2[0][1] = 0; mat2[0][2] = tx; 
		mat2[1][0] = 0; mat2[1][1] = 1; mat2[1][2] = ty;
	...
	case 2:	{for(int i = 0; i < 3; i++){
		...
		mat2[0][0] = sx; mat2[0][1] = 0; mat2[0][2] = 0; 
		mat2[1][0] = 0; mat2[1][1] = sy; mat2[1][2] = 0;
		mat2[2][0] = 0; mat2[2][1] = 0; mat2[2][2] = 1;
		line(pt[0][0],pt[1][0],pt[0][1],pt[1][1]);
	...
	case 3: 		
		...
		mat2[0][0] = cos(r); mat2[0][1] = -sin(r); mat2[0][2] = 0; 
		mat2[1][0] = sin(r); mat2[1][1] = cos(r); mat2[1][2] = 0;
		mat2[2][0] = 0; mat2[2][1] = 0; mat2[2][2] = 1;
		line(pt[0][0],pt[1][0],pt[0][1],pt[1][1]);
		int x_pivot,y_pivot;
